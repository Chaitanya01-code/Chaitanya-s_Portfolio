...
function App() {
  ...
  return (
    <main>
      ...
      <div className="marquee"><div>DATA • DESIGN • CODE • MACHINE LEARNING • DATA • DESIGN • CODE • MACHINE LEARNING • </div></div>
      <section className="stats-panel container"><div className="about-mini"><span className="panel-icon">♙</span><h3>About Me</h3><p>I'm a Computer Science Engineering student and a passionate developer who loves building AI-powered solutions and modern web applications.</p><a href="#about">Know More About Me　♙</a></div></section>
